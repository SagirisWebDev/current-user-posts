 ...
 */
function sagiriswd_current_user_posts_block_init() {
	/**
...
add_action( 'init', 'sagiriswd_current_user_posts_block_init' );
 ...
 */
function sagiriswd_current_user_posts_query_filter() {
	wp_enqueue_script(
...
add_action( 'enqueue_block_editor_assets', 'sagiriswd_current_user_posts_query_filter' );